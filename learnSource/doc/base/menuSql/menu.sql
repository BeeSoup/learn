...
-- 菜单权限
insert into tsys_menu (MENU_CODE, KIND_CODE, TRANS_CODE, SUB_TRANS_CODE, MENU_NAME, MENU_ARG, MENU_ICON, MENU_URL, WINDOW_TYPE, WINDOW_MODEL, TIP, HOT_KEY, PARENT_CODE, ORDER_NO, OPEN_FLAG, TREE_IDX, REMARK, MENU_PLUGIN_NAME, MENU_PLUGIN_DLL, MENU_TYPE, HELP_URL, TENANT_ID, MODULE_ID, MENU_NO, MENU_LEVEL, MENU_I18N, EXT_FIELD, EXT_FIELD1, EXT_FIELD2, EXT_FIELD3, EXT_FIELD4, EXT_FIELD5, MENU_IS_LEAF, MODULE_TYPE, PARAM, APP_CODE, IS_KEEP_ALIVEA, IS_HIDDEN)
values ('productPlanSet', 'amop', 'productPlanSet', 'productPlanSet', '产品方案设置', '', 'icon-chanpinfahang', '/hsfundIdrInfoDcs/productPlanSet', '', '', '', '', 'disclosureManager', 9, '', '#bizroot#amop#disclosureManager#productPlanSet#', ' ', '', '', 'hui', '', 'BIZ', 0, '', null, '', '', '', '', '', '', '', '', '', '', 'hsfundIdrInfoDcs', '1', '0');
insert into tsys_trans (TRANS_CODE, TRANS_NAME, KIND_CODE, MODEL_CODE, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, TRANS_ORDER)
...
-- 菜单权限
insert into tsys_menu (MENU_CODE, KIND_CODE, TRANS_CODE, SUB_TRANS_CODE, MENU_NAME, MENU_ARG, MENU_ICON, MENU_URL, WINDOW_TYPE, WINDOW_MODEL, TIP, HOT_KEY, PARENT_CODE, ORDER_NO, OPEN_FLAG, TREE_IDX, REMARK, MENU_PLUGIN_NAME, MENU_PLUGIN_DLL, MENU_TYPE, HELP_URL, TENANT_ID, MODULE_ID, MENU_NO, MENU_LEVEL, MENU_I18N, EXT_FIELD, EXT_FIELD1, EXT_FIELD2, EXT_FIELD3, EXT_FIELD4, EXT_FIELD5, MENU_IS_LEAF, MODULE_TYPE, PARAM, APP_CODE, IS_KEEP_ALIVEA, IS_HIDDEN)
values ('managerPlanSet', 'amop', 'managerPlanSet', 'managerPlanSet', '管理人方案设置', '', 'icon-weituorenguanli', '/hsfundIdrInfoDcs/managerPlanSet', '', '', '', '', 'disclosureManager', 10, '', '#bizroot#amop#disclosureManager#managerPlanSet#', ' ', '', '', 'hui', '', 'BIZ', 0, '', null, '', '', '', '', '', '', '', '', '', '', 'hsfundIdrInfoDcs', '1', '0');
insert into tsys_trans (TRANS_CODE, TRANS_NAME, KIND_CODE, MODEL_CODE, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, TRANS_ORDER)
...
insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('disclosureManager', '821104005', '管理人代码分页', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104005', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104005', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('disclosureManager', '821104004', '管理人代码', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104004', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104004', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('disclosureManager', '821104003', '字典', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104003', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104003', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('disclosureManager', '821104002', '产品代码筛选', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104002', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('disclosureManager', '821104002', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
delete from tsys_role_right where TRANS_CODE = 'filePublishManager';
delete from tsys_user_right  where trans_code = 'filePublishManager';
delete from tsys_subtrans where TRANS_CODE = 'filePublishManager';
delete from tsys_trans where TRANS_CODE = 'filePublishManager';
delete from tsys_menu where MENU_CODE = 'filePublishManager';

insert into tsys_menu (MENU_CODE, KIND_CODE, TRANS_CODE, SUB_TRANS_CODE, MENU_NAME, MENU_ARG, MENU_ICON, MENU_URL, WINDOW_TYPE, WINDOW_MODEL, TIP, HOT_KEY, PARENT_CODE, ORDER_NO, OPEN_FLAG, TREE_IDX, REMARK, MENU_PLUGIN_NAME, MENU_PLUGIN_DLL, MENU_TYPE, HELP_URL, TENANT_ID, MODULE_ID, MENU_NO, MENU_LEVEL, MENU_I18N, EXT_FIELD, EXT_FIELD1, EXT_FIELD2, EXT_FIELD3, EXT_FIELD4, EXT_FIELD5, MENU_IS_LEAF, MODULE_TYPE, PARAM, APP_CODE, IS_KEEP_ALIVEA, IS_HIDDEN)
values ('filePublishManager', 'amop', 'filePublishManager', 'filePublishManager', '文档发布管理', '', 'icon-chanpinfahang', '/hsfundIdrInfoDcs/filePublishManager', '', '', '', '', 'disclosureManager', 21, '', '#bizroot#amop#disclosureManager#filePublishManager#', ' ', '', '', 'hui', '', 'BIZ', 0, '', null, '', '', '', '', '', '', '', '', '', '', 'hsfundIdrInfoDcs', '1', '0');
insert into tsys_trans (TRANS_CODE, TRANS_NAME, KIND_CODE, MODEL_CODE, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, TRANS_ORDER)
values ('filePublishManager', '文档发布管理', 'filePublishManager', '2', '', '', '', '', '', null);

insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('filePublishManager', 'filePublishManager', '文档发布管理', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', 'filePublishManager', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', 'filePublishManager', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('filePublishManager', '821121001', '分页查询', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', '821121001', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', '821121001', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('filePublishManager', '821121002', '发布', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', '821121002', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', '821121002', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
insert into tsys_subtrans (TRANS_CODE, SUB_TRANS_CODE, SUB_TRANS_NAME, REL_SERV, REL_URL, CTRL_FLAG, LOGIN_FLAG, REMARK, EXT_FIELD_1, EXT_FIELD_2, EXT_FIELD_3, TENANT_ID, SUB_TRANS_ARG, MODULE_TYPE, SUBTRANS_ORDER)
values ('filePublishManager', '821121006', '下载', '', '', '', '', '', '', '', '', '', '', '', null);

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', '821121006', 'admin', 'admin', 0, 0, 0, '1', '', '', '');
insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE, MODULE_TYPE, ACTION_TYPE)
values ('filePublishManager', '821121006', 'admin', 'admin', 0, 0, 0, '2', '', '', '');
...
insert into tsys_dict_item (dict_item_code, dict_entry_code, dict_item_name, dict_item_order) values ('02','IDR_ID_PLFASYDX','管理人方案',20);
...
delete from tsys_dict_entry where dict_entry_code = 'IDR_PUB_CPMJFS';
delete from tsys_dict_item where dict_entry_code = 'IDR_PUB_CPMJFS';
insert into tsys_dict_entry (DICT_ENTRY_CODE, KIND_CODE, DICT_ENTRY_NAME, CTRL_FLAG, REMARK) values ('IDR_PUB_CPMJFS', '0', '募集方式', '0',' ');
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('01', 'IDR_PUB_CPMJFS', '公募',  1);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('02', 'IDR_PUB_CPMJFS', '私募',  2);
...
delete from tsys_dict_entry where dict_entry_code = 'IDR_PUB_CPYZMS';
delete from tsys_dict_item where dict_entry_code = 'IDR_PUB_CPYZMS';
insert into tsys_dict_entry (DICT_ENTRY_CODE, KIND_CODE, DICT_ENTRY_NAME, CTRL_FLAG, REMARK) values ('IDR_PUB_CPYZMS', '0', '产品运作模式', '0', ' ');
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('01', 'IDR_PUB_CPYZMS', '封闭式净值型', 1);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('02', 'IDR_PUB_CPYZMS', '封闭式非净值型', 2);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('03', 'IDR_PUB_CPYZMS', '开放式净值型', 3);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('04', 'IDR_PUB_CPYZMS', '开放式非净值型', 4);
...
delete from tsys_dict_entry where dict_entry_code = 'IDR_PUB_CPXSMBLX';
delete from tsys_dict_item where dict_entry_code = 'IDR_PUB_CPXSMBLX';
insert into tsys_dict_entry (DICT_ENTRY_CODE, KIND_CODE, DICT_ENTRY_NAME, CTRL_FLAG, REMARK) values ('IDR_PUB_CPXSMBLX', '0', '产品销售模板类型', '0', ' ');
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('1405', 'IDR_PUB_CPXSMBLX', '开放式收益类产品', 1);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('1102', 'IDR_PUB_CPXSMBLX', '封闭式收益类产品', 2);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('1303', 'IDR_PUB_CPXSMBLX', '封闭式净值类产品', 3);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('1300', 'IDR_PUB_CPXSMBLX', '开放式净值类产品', 4);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('1200', 'IDR_PUB_CPXSMBLX', '现金管理类产品', 5);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('B102', 'IDR_PUB_CPXSMBLX', '代销产品',  6);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('1307', 'IDR_PUB_CPXSMBLX', 'T+0净值产品',  7);


delete from tsys_dict_entry where dict_entry_code = 'BFAM_CPTZXZ';
delete from tsys_dict_item where dict_entry_code = 'BFAM_CPTZXZ';

delete from tsys_dict_entry where dict_entry_code = 'IDR_PUB_CPTZXZ';
delete from tsys_dict_item where dict_entry_code = 'IDR_PUB_CPTZXZ';
insert into tsys_dict_entry (DICT_ENTRY_CODE, KIND_CODE, DICT_ENTRY_NAME, CTRL_FLAG, REMARK) values ('IDR_PUB_CPTZXZ', '0', '产品投资性质', '0', ' ');
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('01', 'IDR_PUB_CPTZXZ', '固定收益类',  1);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('02', 'IDR_PUB_CPTZXZ', '权益类',  2);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('03', 'IDR_PUB_CPTZXZ', '商品及金融衍生品类',  3);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('04', 'IDR_PUB_CPTZXZ', '混合类',  4);

delete from tsys_dict_entry where dict_entry_code = 'BFAM_CPZT';
delete from tsys_dict_item where dict_entry_code = 'BFAM_CPZT';
delete from tsys_dict_entry where dict_entry_code = 'IDR_PUB_CPZT';
delete from tsys_dict_item where dict_entry_code = 'IDR_PUB_CPZT';
insert into tsys_dict_entry (DICT_ENTRY_CODE, KIND_CODE, DICT_ENTRY_NAME, CTRL_FLAG,  REMARK) values ('IDR_PUB_CPZT', '0', '产品状态', '0', ' ');
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('A0', 'IDR_PUB_CPZT', '申报期', 1);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('A1', 'IDR_PUB_CPZT', '申报失败',  2);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('A2', 'IDR_PUB_CPZT', '申报成功',  3);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('B0', 'IDR_PUB_CPZT', '发行募集期',  4);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('B1', 'IDR_PUB_CPZT', '发行失败', 5);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('C0', 'IDR_PUB_CPZT', '存续期 ',  6);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('D1', 'IDR_PUB_CPZT', '提前到期', 7);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('D2', 'IDR_PUB_CPZT', '正常到期', 8);
insert into tsys_dict_item (DICT_ITEM_CODE, DICT_ENTRY_CODE, DICT_ITEM_NAME, DICT_ITEM_ORDER) values ('D3', 'IDR_PUB_CPZT', '延迟到期 ',9);
...
DELETE FROM amop_base_tempconf where topic_id ='1067453626907100160'
INSERT INTO amop_base_tempconf(tempconf_id, topic_id, element_id, caption, element_hint, display_property, attribute_length, order_no, required, default_value, dict_no, show_flag, regexp_rule, desc_unit, readonly, max_length, int_digit, decimal_digit, nonegative, max_value, min_value, element_tips, format_type, format_method) VALUES ('1067453334924821504', '1067453626907100160', '1067455461395006464', '产品系列', '请选择', 'multiSelect', 12, 10, '1', NULL, 'RPC_PRD_SERIES', '1', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '');
INSERT INTO amop_base_tempconf(tempconf_id, topic_id, element_id, caption, element_hint, display_property, attribute_length, order_no, required, default_value, dict_no, show_flag, regexp_rule, desc_unit, readonly, max_length, int_digit, decimal_digit, nonegative, max_value, min_value, element_tips, format_type, format_method) VALUES ('1067912830960796672', '1067453626907100160', '1067913701891245056', '募集方式', '请输入募集方式', 'multiSelect', 12, 20, '1', NULL, 'IDR_PUB_CPMJFS', '1', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '');
INSERT INTO amop_base_tempconf(tempconf_id, topic_id, element_id, caption, element_hint, display_property, attribute_length, order_no, required, default_value, dict_no, show_flag, regexp_rule, desc_unit, readonly, max_length, int_digit, decimal_digit, nonegative, max_value, min_value, element_tips, format_type, format_method) VALUES ('1068724871711687680', '1067453626907100160', '1068725422692238336', '产品运作模式', '请选择', 'select', 12, 30, '1', NULL, 'IDR_PUB_CPYZMS', '1', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '');
INSERT INTO amop_base_tempconf(tempconf_id, topic_id, element_id, caption, element_hint, display_property, attribute_length, order_no, required, default_value, dict_no, show_flag, regexp_rule, desc_unit, readonly, max_length, int_digit, decimal_digit, nonegative, max_value, min_value, element_tips, format_type, format_method) VALUES ('1068731127901979648', '1067453626907100160', '1068731561324577792', '产品销售模板类型', '请选择', 'select', 12, 40, '1', NULL, 'IDR_PUB_CPXSMBLX', '1', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '');
INSERT INTO amop_base_tempconf(tempconf_id, topic_id, element_id, caption, element_hint, display_property, attribute_length, order_no, required, default_value, dict_no, show_flag, regexp_rule, desc_unit, readonly, max_length, int_digit, decimal_digit, nonegative, max_value, min_value, element_tips, format_type, format_method) VALUES ('1068736782276756480', '1067453626907100160', '1068736984777753600', '投资性质', '请选择', 'multiSelect', 12, 50, '1', NULL, 'IDR_PUB_CPTZXZ', '1', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '');
INSERT INTO amop_base_tempconf(tempconf_id, topic_id, element_id, caption, element_hint, display_property, attribute_length, order_no, required, default_value, dict_no, show_flag, regexp_rule, desc_unit, readonly, max_length, int_digit, decimal_digit, nonegative, max_value, min_value, element_tips, format_type, format_method) VALUES ('1068736833254327296', '1067453626907100160', '1068737021159146496', '产品状态', '请选择', 'multiSelect', 12, 60, '1', NULL, 'IDR_PUB_CPZT', '1', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '');
