...
public class DES {
    ...
    private volatile static DES des = null;
     ...
     * @return
     */
    public static String desStrDec(String key, String data) {
        DES.getDes();

        String str = des.strDec(data, key, "", "");
        return str;
    }
     ...
     * @return
     */
    public static String desStrEnc(String key, String data) {
        DES.getDes();

        String str = des.strEnc(data, key, "", "");
        return str;
    }
