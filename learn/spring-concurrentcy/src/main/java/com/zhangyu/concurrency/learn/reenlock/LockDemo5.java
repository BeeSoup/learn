 ...
 *
 * 中断协作机制，通过状态，自定义处理
 * interrupted 清除 isInterrupted 判断 interrupt标记别人
 * isHeldByCurrentThread 判断当前线程是否保持锁定
 *
 * hasQueuedThread 获取线程是否在等待
 */
public class LockDemo5 {

    static final Logger log = LoggerFactory.getLogger(LockDemo5.class);
