...
import com.xQuant.platform.app.newsettle.service.InstructionSettleFlowInitWarpper;
 ...
 */
//@Component
public class InstructionSettleFlowInitWarpperImpl implements InitializingBean, InstructionSettleFlowInitWarpper {
...
//          第一层flowType 将根据数据库配置的int值转成枚举类，然后获取name 第二层 正反方向
    ...
    /**
     * 获取Map 提供浅拷贝副本 如果想操作链表请clone一份
     */
    public static Map<String, Map<String, LinkedList<TaskFlowService>>> getMap() {
